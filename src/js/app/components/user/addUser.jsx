...
const AccountTextField = React.createClass({
	getInitialState: function () {
		return {
			errorText: this.props.defaultValue ? '' : '必填'
		};
	},
	...
	handleAccountBlur: function (e) {
		...
		reqwest({
			...
			console.log(123);
			if (res.statusCode === 0 && res.resultCode === 0 && res.id !== this.props.editId) {
				this.setState({
					errorText: res.message
				});
				this.props.onQueryAccount(true);
			} else {
				this.props.onQueryAccount(false);
			}
		...
		return (
			<div>
				...
				<RadioButtonGroup
					...
					defaultSelected={this.props.defaultValue.toString()}
					>
					<RadioButton
						value="0"
						label="男"
